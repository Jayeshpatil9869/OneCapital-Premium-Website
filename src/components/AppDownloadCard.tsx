  ...
  return (
    <div
      className={cn(
        ...
        'glass-panel oc-card-hover-glow',
    ...
    >
      <div className="shrink-0 rounded-lg border border-white/10 bg-white p-1.5">
        <img
          ...
          alt="Scan to download the One Capital app"
          width={72}
          height={72}
          className="h-18 w-18 rounded-md object-contain"
          decoding="async"
        />
      </div>
      ...
      <div className="flex min-w-0 flex-col gap-2.5">
        <div className="min-w-0">
          <p className="text-balance text-sm font-medium leading-snug tracking-tight text-white">
            Track all your investments in one place
          </p>
          <p className="mt-1.5 font-mono text-[11px] uppercase tracking-widest text-text-muted">
            Download One Capital App
          </p>
        </div>
